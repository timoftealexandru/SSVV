	...
	public void Run()
	{
		...
		while(cmd!=0)
		{
			...
			{								
				...
				System.out.println("Enter monthly value:");
				Integer mv = Integer.parseInt(in.nextLine());
				System.out.println("Enter contributed value for member:");
				Integer cv = Integer.parseInt(in.nextLine());
				Member aMemebr = new Member(name,id,mv,cv);
